package com.dongduong.springmvc.test.configuration;
...
@ComponentScan({ "com.dongduong.springmvc.dao" })
public class HibernateTestConfiguration {
    ...
    public LocalSessionFactoryBean sessionFactory() {
        ...
        sessionFactory.setPackagesToScan(new String[] { "com.dongduong.springmvc.model" });
